...
def stochastic_gradient_descent(y, tx, initial_w, batch_size, max_iters, gamma, error_type='mae'):
    ...
    for step in range(max_iters):
        ...
        for batch_y, batch_tx in batch_iter(y, tx, batch_size, num_batches=1, shuffle=True):
            loss = compute_loss(batch_y, batch_tx, w, error_type)
            gradient = compute_stoch_gradient(batch_y, batch_tx, w, error_type)
